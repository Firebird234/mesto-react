        ...
        return(
                    <article className="elements__item">
                        ...
                        <div className="elements__info">
                            ...
                            <button className={`elements__like ${this.props.card.likes.some( el =>el._id === this.context._id) && 'elements__like_active'}`} 
                            onClick = {this.handleLikeClick} type="button"></button>
                            <span className="elements__like-count">{this.props.card.likes.length}</span>
                            </div>
                        </div>
                        <button onClick = {this.handleDeleteClick} className={`elements__delete ${this.props.card.owner._id !== this.context._id && 'elements__delete_hidden'}`}></button>
                    </article> 
                )
