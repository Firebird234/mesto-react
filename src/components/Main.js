    ...
    return(
        ...
        <section className="profile">
            <div className="profile__info-wrapper">
                <div className="profile__illustration-wrapper">
                    ...
                    <img className="profile__illustration" alt="Аватар пользователя" src={currentUser.avatar}/>
        ...
        <section className="elements">
            ...
            props.cards.map((el,ind) => {
                return (
                <Card onCardDelete = {props.onCardDelete} onCardLike = {props.onCardLike} card = {el} onImage = {props.onImage}  key = {el._id}/>)
            })
            }
